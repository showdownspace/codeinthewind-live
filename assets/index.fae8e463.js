 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const ju="FirebaseError";class qe extends Error{constructor(e,t,i){super(t),this.code=e,this.customData=i,this.name=ju,Object.setPrototypeOf(this,qe.prototype),Error.captureStackTrace&&Error.captureStackTrace(this,pt.prototype.create)}}class pt{constructor(e,t,i){this.service=e,this.serviceName=t,this.errors=i}create(e,...t){const i=t[0]||{},s=`${this.service}/${e}`,r=this.errors[e],o=r?Bu(r,i):"Error",a=`${this.serviceName}: ${o} (${s}).`;return new qe(s,a,i)}}function Bu(n,e){return n.replace(Vu,(t,i)=>{const s=e[i];return s!=null?String(s):`<${i}?>`})}const Vu=/\{\$([^}]+)}/g;/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function en(n,e){return new Promise((t,i)=>{n.onsuccess=s=>{t(s.target.result)},n.onerror=s=>{var r;i(`${e}: ${(r=s.target.error)===null||r===void 0?void 0:r.message}`)}})}class jr{constructor(e){this._db=e,this.objectStoreNames=this._db.objectStoreNames}transaction(e,t="readonly"){return new xa(this._db.transaction.call(this._db,e,t))}createObjectStore(e,t){return new Da(this._db.createObjectStore(e,t))}close(){this._db.close()}}class xa{constructor(e){this._transaction=e,this.complete=new Promise((t,i)=>{this._transaction.oncomplete=function(){t()},this._transaction.onerror=()=>{i(this._transaction.error)},this._transaction.onabort=()=>{i(this._transaction.error)}})}objectStore(e){return new Da(this._transaction.objectStore(e))}}class Da{constructor(e){this._store=e}index(e){return new Br(this._store.index(e))}createIndex(e,t,i){return new Br(this._store.createIndex(e,t,i))}get(e){const t=this._store.get(e);return en(t,"Error reading from IndexedDB")}put(e,t){const i=this._store.put(e,t);return en(i,"Error writing to IndexedDB")}delete(e){const t=this._store.delete(e);return en(t,"Error deleting from IndexedDB")}clear(){const e=this._store.clear();return en(e,"Error clearing IndexedDB object store")}}class Br{constructor(e){this._index=e}get(e){const t=this._index.get(e);return en(t,"Error reading from IndexedDB")}}function Ma(n,e,t){return new Promise((i,s)=>{try{const r=indexedDB.open(n,e);r.onsuccess=o=>{i(new jr(o.target.result))},r.onerror=o=>{var a;s(`Error opening indexedDB: ${(a=o.target.error)===null||a===void 0?void 0:a.message}`)},r.onupgradeneeded=o=>{t(new jr(r.result),o.oldVersion,o.newVersion,new xa(r.transaction))}}catch(r){s(`Error opening indexedDB: ${r.message}`)}})}class ve{constructor(e,t,i){this.name=e,this.instanceFactory=t,this.type=i,this.multipleInstances=!1,this.serviceProps={},this.instantiationMode="LAZY",this.onInstanceCreated=null}setInstantiationMode(e){return this.instantiationMode=e,this}setMultipleInstances(e){return this.multipleInstances=e,this}setServiceProps(e){return this.serviceProps=e,this}setInstanceCreatedCallback(e){return this.onInstanceCreated=e,this}}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const js="5",qa="v",za="s",Ga="r",Ka="f",Ya=/(console\.firebase|firebase-console-\w+\.corp|firebase\.corp)\.google\.com/,Qa="ls",pd="p",ws="ac",Ja="websocket",Xa="long_polling";/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Yi={},Qi={};function Bs(n){const e=n.toString();return Yi[e]||(Yi[e]=new md),Yi[e]}function yd(n,e){const t=n.toString();return Qi[t]||(Qi[t]=e()),Qi[t]}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const ro=32,oo=768;class ${constructor(e,t){if(t===void 0){this.pieces_=e.split("/");let i=0;for(let s=0;s<this.pieces_.length;s++)this.pieces_[s].length>0&&(this.pieces_[i]=this.pieces_[s],i++);this.pieces_.length=i,this.pieceNum_=0}else this.pieces_=e,this.pieceNum_=t}toString(){let e="";for(let t=this.pieceNum_;t<this.pieces_.length;t++)this.pieces_[t]!==""&&(e+="/"+this.pieces_[t]);return e||"/"}}function F(){return new $("")}function x(n){return n.pieceNum_>=n.pieces_.length?null:n.pieces_[n.pieceNum_]}function Be(n){return n.pieces_.length-n.pieceNum_}function W(n){let e=n.pieceNum_;return e<n.pieces_.length&&e++,new $(n.pieces_,e)}function al(n){return n.pieceNum_<n.pieces_.length?n.pieces_[n.pieces_.length-1]:null}function Hd(n){let e="";for(let t=n.pieceNum_;t<n.pieces_.length;t++)n.pieces_[t]!==""&&(e+="/"+encodeURIComponent(String(n.pieces_[t])));return e||"/"}function ll(n,e=0){return n.pieces_.slice(n.pieceNum_+e)}function cl(n){if(n.pieceNum_>=n.pieces_.length)return null;const e=[];for(let t=n.pieceNum_;t<n.pieces_.length-1;t++)e.push(n.pieces_[t]);return new $(e,0)}function G(n,e){const t=[];for(let i=n.pieceNum_;i<n.pieces_.length;i++)t.push(n.pieces_[i]);if(e instanceof $)for(let i=e.pieceNum_;i<e.pieces_.length;i++)t.push(e.pieces_[i]);else{const i=e.split("/");for(let s=0;s<i.length;s++)i[s].length>0&&t.push(i[s])}return new $(t,0)}function D(n){return n.pieceNum_>=n.pieces_.length}function re(n,e){const t=x(n),i=x(e);if(t===null)return e;if(t===i)return re(W(n),W(e));throw new Error("INTERNAL ERROR: innerPath ("+e+") is not within outerPath ("+n+")")}function zs(n,e){if(Be(n)!==Be(e))return!1;for(let t=n.pieceNum_,i=e.pieceNum_;t<=n.pieces_.length;t++,i++)if(n.pieces_[t]!==e.pieces_[i])return!1;return!0}function _e(n,e){let t=n.pieceNum_,i=e.pieceNum_;if(Be(n)>Be(e))return!1;for(;t<n.pieces_.length;){if(n.pieces_[t]!==e.pieces_[i])return!1;++t,++i}return!0}class jd{constructor(e,t){this.errorPrefix_=t,this.parts_=ll(e,0),this.byteLength_=Math.max(1,this.parts_.length);for(let i=0;i<this.parts_.length;i++)this.byteLength_+=Ti(this.parts_[i]);ul(this)}}function Bd(n,e){n.parts_.length>0&&(n.byteLength_+=1),n.parts_.push(e),n.byteLength_+=Ti(e),ul(n)}function Vd(n){const e=n.parts_.pop();n.byteLength_-=Ti(e),n.parts_.length>0&&(n.byteLength_-=1)}function ul(n){if(n.byteLength_>oo)throw new Error(n.errorPrefix_+"has a key path longer than "+oo+" bytes ("+n.byteLength_+").");if(n.parts_.length>ro)throw new Error(n.errorPrefix_+"path specified exceeds the maximum depth that can be written ("+ro+") or object contains a cycle "+Ke(n))}function Ke(n){return n.parts_.length===0?"":"in property '"+n.parts_.join(".")+"'"}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Ys{constructor(e){this.index_=e}updateChild(e,t,i,s,r,o){I(e.isIndexed(this.index_),"A node must be indexed if only a child is updated");const a=e.getImmediateChild(t);return a.getChild(s).equals(i.getChild(s))&&a.isEmpty()===i.isEmpty()||(o!=null&&(i.isEmpty()?e.hasChild(t)?o.trackChildChange(mn(t,a)):I(e.isLeafNode(),"A child remove without an old child only makes sense on a leaf node"):a.isEmpty()?o.trackChildChange(Dt(t,i)):o.trackChildChange(yn(t,i,a))),e.isLeafNode()&&i.isEmpty())?e:e.updateImmediateChild(t,i).withIndex(this.index_)}updateFullNode(e,t,i){return i!=null&&(e.isLeafNode()||e.forEachChild(B,(s,r)=>{t.hasChild(s)||i.trackChildChange(mn(s,r))}),t.isLeafNode()||t.forEachChild(B,(s,r)=>{if(e.hasChild(s)){const o=e.getImmediateChild(s);o.equals(r)||i.trackChildChange(yn(s,r,o))}else i.trackChildChange(Dt(s,r))})),t.withIndex(this.index_)}updatePriority(e,t){return e.isEmpty()?R.EMPTY_NODE:e.updatePriority(t)}filtersNodes(){return!1}getIndexedFilter(){return this}getIndex(){return this.index_}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Sp=/[\[\].#$\/\u0000-\u001F\u007F]/,kp=/[\[\].#$\u0000-\u001F\u007F]/,es=10*1024*1024,Ul=function(n){return typeof n=="string"&&n.length!==0&&!Sp.test(n)},$l=function(n){return typeof n=="string"&&n.length!==0&&!kp.test(n)},Rp=function(n){return n&&(n=n.replace(/^\/*\.info(\/|$)/,"/")),$l(n)},Wl=function(n,e,t){const i=t instanceof $?new jd(t,n):t;if(e===void 0)throw new Error(n+"contains undefined "+Ke(i));if(typeof e=="function")throw new Error(n+"contains a function "+Ke(i)+" with contents = "+e.toString());if(ja(e))throw new Error(n+"contains "+e.toString()+" "+Ke(i));if(typeof e=="string"&&e.length>es/3&&Ti(e)>es)throw new Error(n+"contains a string greater than "+es+" utf8 bytes "+Ke(i)+" ('"+e.substring(0,50)+"...')");if(e&&typeof e=="object"){let s=!1,r=!1;if(ae(e,(o,a)=>{if(o===".value")s=!0;else if(o!==".priority"&&o!==".sv"&&(r=!0,!Ul(o)))throw new Error(n+" contains an invalid key ("+o+") "+Ke(i)+`.  Keys must be non-empty strings and can't contain ".", "#", "$", "/", "[", or "]"`);Bd(i,o),Wl(n,a,i),Vd(i)}),s&&r)throw new Error(n+' contains ".value" child '+Ke(i)+" in addition to actual children.")}},Hl=function(n,e,t,i){if(!(i&&t===void 0)&&!$l(t))throw new Error(Oa(n,e)+'was an invalid path = "'+t+`". Paths must be non-empty strings and can't contain ".", "#", "$", "[", or "]"`)},Ap=function(n,e,t,i){t&&(t=t.replace(/^\/*\.info(\/|$)/,"/")),Hl(n,e,t,i)},Np=function(n,e){const t=e.path.toString();if(typeof e.repoInfo.host!="string"||e.repoInfo.host.length===0||!Ul(e.repoInfo.namespace)&&e.repoInfo.host.split(":")[0]!=="localhost"||t.length!==0&&!Rp(t))throw new Error(Oa(n,"url")+`must be a valid firebase URL and the path can't contain ".", "#", "$", "[", or "]".`)};/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Os(){var n;return typeof self!="undefined"&&((n=self.location)===null||n===void 0?void 0:n.href)||""}function Fm(){return jo()==="http:"||jo()==="https:"}function jo(){var n;return typeof self!="undefined"&&((n=self.location)===null||n===void 0?void 0:n.protocol)||null}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function Bm(n,e){return Ui(n,"POST","/v1/accounts:delete",e)}async function Vm(n,e){return Ui(n,"POST","/v1/accounts:lookup",e)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Dc{constructor(){this.type="NONE",this.storage={}}async _isAvailable(){return!0}async _set(e,t){this.storage[e]=t}async _get(e){const t=this.storage[e];return t===void 0?null:t}async _remove(e){delete this.storage[e]}_addListener(e,t){}_removeListener(e,t){}}Dc.type="NONE";const Bo=Dc;/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function jc(n,e=[]){let t;switch(n){case"Browser":t=Vo(ie());break;case"Worker":t=`${Vo(ie())}-${n}`;break;default:t=n}const i=e.length?e.join(","):"FirebaseCore-web";return`${t}/JsCore/${Rn}/${i}`}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Bc{constructor(e,t){this.providerId=e,this.signInMethod=t}toJSON(){return Re("not implemented")}_getIdTokenResponse(e){return Re("not implemented")}_linkToIdToken(e,t){return Re("not implemented")}_getReauthenticationResolver(e){return Re("not implemented")}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Wy=10*60*1e3;class Hy{constructor(e){this.auth=e,this.cachedEventUids=new Set,this.consumers=new Set,this.queuedRedirectEvent=null,this.hasHandledPotentialRedirect=!1,this.lastProcessedEventTime=Date.now()}registerConsumer(e){this.consumers.add(e),this.queuedRedirectEvent&&this.isEventForConsumer(this.queuedRedirectEvent,e)&&(this.sendToConsumer(this.queuedRedirectEvent,e),this.saveEventToCache(this.queuedRedirectEvent),this.queuedRedirectEvent=null)}unregisterConsumer(e){this.consumers.delete(e)}onEvent(e){if(this.hasEventBeenHandled(e))return!1;let t=!1;return this.consumers.forEach(i=>{this.isEventForConsumer(e,i)&&(t=!0,this.sendToConsumer(e,i),this.saveEventToCache(e))}),this.hasHandledPotentialRedirect||!jy(e)||(this.hasHandledPotentialRedirect=!0,t||(this.queuedRedirectEvent=e,t=!0)),t}sendToConsumer(e,t){var i;if(e.error&&!nu(e)){const s=((i=e.error.code)===null||i===void 0?void 0:i.split("auth/")[1])||"internal-error";t.onError(Ee(this.auth,s))}else t.onAuthEvent(e)}isEventForConsumer(e,t){const i=t.eventId===null||!!e.eventId&&e.eventId===t.eventId;return t.filter.includes(e.type)&&i}hasEventBeenHandled(e){return Date.now()-this.lastProcessedEventTime>=Wy&&this.cachedEventUids.clear(),this.cachedEventUids.has(Yo(e))}saveEventToCache(e){this.cachedEventUids.add(Yo(e)),this.lastProcessedEventTime=Date.now()}}function Yo(n){return[n.type,n.eventId,n.sessionId,n.tenantId].filter(e=>e).join("-")}function nu({type:n,error:e}){return n==="unknown"&&(e==null?void 0:e.code)==="auth/no-auth-event"}function jy(n){switch(n.type){case"signInViaRedirect":case"linkViaRedirect":case"reauthViaRedirect":return!0;case"unknown":return nu(n);default:return!1}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * @namespace
 * @public
 */var t=function(i){var s=/(?:^|\s)lang(?:uage)?-([\w-]+)(?=\s|$)/i,r=0,o={},a={manual:i.Prism&&i.Prism.manual,disableWorkerMessageHandler:i.Prism&&i.Prism.disableWorkerMessageHandler,util:{encode:function p(f){return f instanceof l?new l(f.type,p(f.content),f.alias):Array.isArray(f)?f.map(p):f.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/\u00a0/g," ")},type:function(p){return Object.prototype.toString.call(p).slice(8,-1)},objId:function(p){return p.__id||Object.defineProperty(p,"__id",{value:++r}),p.__id},clone:function p(f,y){y=y||{};var _,b;switch(a.util.type(f)){case"Object":if(b=a.util.objId(f),y[b])return y[b];_={},y[b]=_;for(var C in f)f.hasOwnProperty(C)&&(_[C]=p(f[C],y));return _;case"Array":return b=a.util.objId(f),y[b]?y[b]:(_=[],y[b]=_,f.forEach(function(k,T){_[T]=p(k,y)}),_);default:return f}},getLanguage:function(p){for(;p;){var f=s.exec(p.className);if(f)return f[1].toLowerCase();p=p.parentElement}return"none"},setLanguage:function(p,f){p.className=p.className.replace(RegExp(s,"gi"),""),p.classList.add("language-"+f)},currentScript:function(){if(typeof document=="undefined")return null;if("currentScript"in document&&1<2)return document.currentScript;try{throw new Error}catch(_){var p=(/at [^(\r\n]*\((.*):[^:]+:[^:]+\)$/i.exec(_.stack)||[])[1];if(p){var f=document.getElementsByTagName("script");for(var y in f)if(f[y].src==p)return f[y]}return null}},isActive:function(p,f,y){for(var _="no-"+f;p;){var b=p.classList;if(b.contains(f))return!0;if(b.contains(_))return!1;p=p.parentElement}return!!y}},languages:{plain:o,plaintext:o,text:o,txt:o,extend:function(p,f){var y=a.util.clone(a.languages[p]);for(var _ in f)y[_]=f[_];return y},insertBefore:function(p,f,y,_){_=_||a.languages;var b=_[p],C={};for(var k in b)if(b.hasOwnProperty(k)){if(k==f)for(var T in y)y.hasOwnProperty(T)&&(C[T]=y[T]);y.hasOwnProperty(k)||(C[k]=b[k])}var L=_[p];return _[p]=C,a.languages.DFS(a.languages,function(V,he){he===L&&V!=p&&(this[V]=C)}),C},DFS:function p(f,y,_,b){b=b||{};var C=a.util.objId;for(var k in f)if(f.hasOwnProperty(k)){y.call(f,k,f[k],_||k);var T=f[k],L=a.util.type(T);L==="Object"&&!b[C(T)]?(b[C(T)]=!0,p(T,y,null,b)):L==="Array"&&!b[C(T)]&&(b[C(T)]=!0,p(T,y,k,b))}}},plugins:{},highlightAll:function(p,f){a.highlightAllUnder(document,p,f)},highlightAllUnder:function(p,f,y){var _={callback:y,container:p,selector:'code[class*="language-"], [class*="language-"] code, code[class*="lang-"], [class*="lang-"] code'};a.hooks.run("before-highlightall",_),_.elements=Array.prototype.slice.apply(_.container.querySelectorAll(_.selector)),a.hooks.run("before-all-elements-highlight",_);for(var b=0,C;C=_.elements[b++];)a.highlightElement(C,f===!0,_.callback)},highlightElement:function(p,f,y){var _=a.util.getLanguage(p),b=a.languages[_];a.util.setLanguage(p,_);var C=p.parentElement;C&&C.nodeName.toLowerCase()==="pre"&&a.util.setLanguage(C,_);var k=p.textContent,T={element:p,language:_,grammar:b,code:k};function L(he){T.highlightedCode=he,a.hooks.run("before-insert",T),T.element.innerHTML=T.highlightedCode,a.hooks.run("after-highlight",T),a.hooks.run("complete",T),y&&y.call(T.element)}if(a.hooks.run("before-sanity-check",T),C=T.element.parentElement,C&&C.nodeName.toLowerCase()==="pre"&&!C.hasAttribute("tabindex")&&C.setAttribute("tabindex","0"),!T.code){a.hooks.run("complete",T),y&&y.call(T.element);return}if(a.hooks.run("before-highlight",T),!T.grammar){L(a.util.encode(T.code));return}if(f&&i.Worker){var V=new Worker(a.filename);V.onmessage=function(he){L(he.data)},V.postMessage(JSON.stringify({language:T.language,code:T.code,immediateClose:!0}))}else L(a.highlight(T.code,T.grammar,T.language))},highlight:function(p,f,y){var _={code:p,grammar:f,language:y};if(a.hooks.run("before-tokenize",_),!_.grammar)throw new Error('The language "'+_.language+'" has no grammar.');return _.tokens=a.tokenize(_.code,_.grammar),a.hooks.run("after-tokenize",_),l.stringify(a.util.encode(_.tokens),_.language)},tokenize:function(p,f){var y=f.rest;if(y){for(var _ in y)f[_]=y[_];delete f.rest}var b=new u;return d(b,b.head,p),h(p,b,f,b.head,0),v(b)},hooks:{all:{},add:function(p,f){var y=a.hooks.all;y[p]=y[p]||[],y[p].push(f)},run:function(p,f){var y=a.hooks.all[p];if(!(!y||!y.length))for(var _=0,b;b=y[_++];)b(f)}},Token:l};i.Prism=a;function l(p,f,y,_){this.type=p,this.content=f,this.alias=y,this.length=(_||"").length|0}l.stringify=function p(f,y){if(typeof f=="string")return f;if(Array.isArray(f)){var _="";return f.forEach(function(L){_+=p(L,y)}),_}var b={type:f.type,content:p(f.content,y),tag:"span",classes:["token",f.type],attributes:{},language:y},C=f.alias;C&&(Array.isArray(C)?Array.prototype.push.apply(b.classes,C):b.classes.push(C)),a.hooks.run("wrap",b);var k="";for(var T in b.attributes)k+=" "+T+'="'+(b.attributes[T]||"").replace(/"/g,"&quot;")+'"';return"<"+b.tag+' class="'+b.classes.join(" ")+'"'+k+">"+b.content+"</"+b.tag+">"};function c(p,f,y,_){p.lastIndex=f;var b=p.exec(y);if(b&&_&&b[1]){var C=b[1].length;b.index+=C,b[0]=b[0].slice(C)}return b}function h(p,f,y,_,b,C){for(var k in y)if(!(!y.hasOwnProperty(k)||!y[k])){var T=y[k];T=Array.isArray(T)?T:[T];for(var L=0;L<T.length;++L){if(C&&C.cause==k+","+L)return;var V=T[L],he=V.inside,le=!!V.lookbehind,vt=!!V.greedy,Hn=V.alias;if(vt&&!V.pattern.global){var jn=V.pattern.toString().match(/[imsuy]*$/)[0];V.pattern=RegExp(V.pattern.source,jn+"g")}for(var Vt=V.pattern||V,M=_.next,j=b;M!==f.tail&&!(C&&j>=C.reach);j+=M.value.length,M=M.next){var be=M.value;if(f.length>p.length)return;if(!(be instanceof l)){var ze=1,se;if(vt){if(se=c(Vt,j,p,le),!se||se.index>=p.length)break;var Bn=se.index,lu=se.index+se[0].length,Me=j;for(Me+=M.value.length;Bn>=Me;)M=M.next,Me+=M.value.length;if(Me-=M.value.length,j=Me,M.value instanceof l)continue;for(var qt=M;qt!==f.tail&&(Me<lu||typeof qt.value=="string");qt=qt.next)ze++,Me+=qt.value.length;ze--,be=p.slice(j,Me),se.index-=j}else if(se=c(Vt,0,be,le),!se)continue;var Bn=se.index,Vn=se[0],ji=be.slice(0,Bn),xr=be.slice(Bn+Vn.length),Bi=j+be.length;C&&Bi>C.reach&&(C.reach=Bi);var qn=M.prev;ji&&(qn=d(f,qn,ji),j+=ji.length),g(f,qn,ze);var cu=new l(k,he?a.tokenize(Vn,he):Vn,Hn,Vn);if(M=d(f,qn,cu),xr&&d(f,M,xr),ze>1){var Vi={cause:k+","+L,reach:Bi};h(p,f,y,M.prev,j,Vi),C&&Vi.reach>C.reach&&(C.reach=Vi.reach)}}}}}}function u(){var p={value:null,prev:null,next:null},f={value:null,prev:p,next:null};p.next=f,this.head=p,this.tail=f,this.length=0}function d(p,f,y){var _=f.next,b={value:y,prev:f,next:_};return f.next=b,_.prev=b,p.length++,b}function g(p,f,y){for(var _=f.next,b=0;b<y&&_!==p.tail;b++)_=_.next;f.next=_,_.prev=f,p.length-=b}function v(p){for(var f=[],y=p.head.next;y!==p.tail;)f.push(y.value),y=y.next;return f}if(!i.document)return i.addEventListener&&(a.disableWorkerMessageHandler||i.addEventListener("message",function(p){var f=JSON.parse(p.data),y=f.language,_=f.code,b=f.immediateClose;i.postMessage(a.highlight(_,a.languages[y],y)),b&&i.close()},!1)),a;var m=a.util.currentScript();m&&(a.filename=m.src,m.hasAttribute("data-manual")&&(a.manual=!0));function w(){a.manual||a.highlightAll()}if(!a.manual){var E=document.readyState;E==="loading"||E==="interactive"&&m&&m.defer?document.addEventListener("DOMContentLoaded",w):window.requestAnimationFrame?window.requestAnimationFrame(w):window.setTimeout(w,16)}return a}(e);n.exports&&(n.exports=t),typeof ta!="undefined"&&(ta.Prism=t),t.languages.markup={comment:{pattern:/<!--(?:(?!<!--)[\s\S])*?-->/,greedy:!0},prolog:{pattern:/<\?[\s\S]+?\?>/,greedy:!0},doctype:{pattern:/<!DOCTYPE(?:[^>"'[\]]|"[^"]*"|'[^']*')+(?:\[(?:[^<"'\]]|"[^"]*"|'[^']*'|<(?!!--)|<!--(?:[^-]|-(?!->))*-->)*\]\s*)?>/i,greedy:!0,inside:{"internal-subset":{pattern:/(^[^\[]*\[)[\s\S]+(?=\]>$)/,lookbehind:!0,greedy:!0,inside:null},string:{pattern:/"[^"]*"|'[^']*'/,greedy:!0},punctuation:/^<!|>$|[[\]]/,"doctype-tag":/^DOCTYPE/i,name:/[^\s<>'"]+/}},cdata:{pattern:/<!\[CDATA\[[\s\S]*?\]\]>/i,greedy:!0},tag:{pattern:/<\/?(?!\d)[^\s>\/=$<%]+(?:\s(?:\s*[^\s>\/=]+(?:\s*=\s*(?:"[^"]*"|'[^']*'|[^\s'">=]+(?=[\s>]))|(?=[\s/>])))+)?\s*\/?>/,greedy:!0,inside:{tag:{pattern:/^<\/?[^\s>\/]+/,inside:{punctuation:/^<\/?/,namespace:/^[^\s>\/:]+:/}},"special-attr":[],"attr-value":{pattern:/=\s*(?:"[^"]*"|'[^']*'|[^\s'">=]+)/,inside:{punctuation:[{pattern:/^=/,alias:"attr-equals"},/"|'/]}},punctuation:/\/?>/,"attr-name":{pattern:/[^\s>\/]+/,inside:{namespace:/^[^\s>\/:]+:/}}}},entity:[{pattern:/&[\da-z]{1,8};/i,alias:"named-entity"},/&#x?[\da-f]{1,8};/i]},t.languages.markup.tag.inside["attr-value"].inside.entity=t.languages.markup.entity,t.languages.markup.doctype.inside["internal-subset"].inside=t.languages.markup,t.hooks.add("wrap",function(i){i.type==="entity"&&(i.attributes.title=i.content.replace(/&amp;/,"&"))}),Object.defineProperty(t.languages.markup.tag,"addInlined",{value:function(s,r){var o={};o["language-"+r]={pattern:/(^<!\[CDATA\[)[\s\S]+?(?=\]\]>$)/i,lookbehind:!0,inside:t.languages[r]},o.cdata=/^<!\[CDATA\[|\]\]>$/i;var a={"included-cdata":{pattern:/<!\[CDATA\[[\s\S]*?\]\]>/i,inside:o}};a["language-"+r]={pattern:/[\s\S]+/,inside:t.languages[r]};var l={};l[s]={pattern:RegExp(/(<__[^>]*>)(?:<!\[CDATA\[(?:[^\]]|\](?!\]>))*\]\]>|(?!<!\[CDATA\[)[\s\S])*?(?=<\/__>)/.source.replace(/__/g,function(){return s}),"i"),lookbehind:!0,greedy:!0,inside:a},t.languages.insertBefore("markup","cdata",l)}}),Object.defineProperty(t.languages.markup.tag,"addAttribute",{value:function(i,s){t.languages.markup.tag.inside["special-attr"].push({pattern:RegExp(/(^|["'\s])/.source+"(?:"+i+")"+/\s*=\s*(?:"[^"]*"|'[^']*'|[^\s'">=]+(?=[\s>]))/.source,"i"),lookbehind:!0,inside:{"attr-name":/^[^\s=]+/,"attr-value":{pattern:/=[\s\S]+/,inside:{value:{pattern:/(^=\s*(["']|(?!["'])))\S[\s\S]*(?=\2$)/,lookbehind:!0,alias:[s,"language-"+s],inside:t.languages[s]},punctuation:[{pattern:/^=/,alias:"attr-equals"},/"|'/]}}}})}}),t.languages.html=t.languages.markup,t.languages.mathml=t.languages.markup,t.languages.svg=t.languages.markup,t.languages.xml=t.languages.extend("markup",{}),t.languages.ssml=t.languages.xml,t.languages.atom=t.languages.xml,t.languages.rss=t.languages.xml,function(i){var s=/(?:"(?:\\(?:\r\n|[\s\S])|[^"\\\r\n])*"|'(?:\\(?:\r\n|[\s\S])|[^'\\\r\n])*')/;i.languages.css={comment:/\/\*[\s\S]*?\*\//,atrule:{pattern:/@[\w-](?:[^;{\s]|\s+(?![\s{]))*(?:;|(?=\s*\{))/,inside:{rule:/^@[\w-]+/,"selector-function-argument":{pattern:/(\bselector\s*\(\s*(?![\s)]))(?:[^()\s]|\s+(?![\s)])|\((?:[^()]|\([^()]*\))*\))+(?=\s*\))/,lookbehind:!0,alias:"selector"},keyword:{pattern:/(^|[^\w-])(?:and|not|only|or)(?![\w-])/,lookbehind:!0}}},url:{pattern:RegExp("\\burl\\((?:"+s.source+"|"+/(?:[^\\\r\n()"']|\\[\s\S])*/.source+")\\)","i"),greedy:!0,inside:{function:/^url/i,punctuation:/^\(|\)$/,string:{pattern:RegExp("^"+s.source+"$"),alias:"url"}}},selector:{pattern:RegExp(`(^|[{}\\s])[^{}\\s](?:[^{};"'\\s]|\\s+(?![\\s{])|`+s.source+")*(?=\\s*\\{)"),lookbehind:!0},string:{pattern:s,greedy:!0},property:{pattern:/(^|[^-\w\xA0-\uFFFF])(?!\s)[-_a-z\xA0-\uFFFF](?:(?!\s)[-\w\xA0-\uFFFF])*(?=\s*:)/i,lookbehind:!0},important:/!important\b/i,function:{pattern:/(^|[^-a-z0-9])[-a-z0-9]+(?=\()/i,lookbehind:!0},punctuation:/[(){};:,]/},i.languages.css.atrule.inside.rest=i.languages.css;var r=i.languages.markup;r&&(r.tag.addInlined("style","css"),r.tag.addAttribute("style","css"))}(t),t.languages.clike={comment:[{pattern:/(^|[^\\])\/\*[\s\S]*?(?:\*\/|$)/,lookbehind:!0,greedy:!0},{pattern:/(^|[^\\:])\/\/.*/,lookbehind:!0,greedy:!0}],string:{pattern:/(["'])(?:\\(?:\r\n|[\s\S])|(?!\1)[^\\\r\n])*\1/,greedy:!0},"class-name":{pattern:/(\b(?:class|extends|implements|instanceof|interface|new|trait)\s+|\bcatch\s+\()[\w.\\]+/i,lookbehind:!0,inside:{punctuation:/[.\\]/}},keyword:/\b(?:break|catch|continue|do|else|finally|for|function|if|in|instanceof|new|null|return|throw|try|while)\b/,boolean:/\b(?:false|true)\b/,function:/\b\w+(?=\()/,number:/\b0x[\da-f]+\b|(?:\b\d+(?:\.\d*)?|\B\.\d+)(?:e[+-]?\d+)?/i,operator:/[<>]=?|[!=]=?=?|--?|\+\+?|&&?|\|\|?|[?*/~^%]/,punctuation:/[{}[\];(),.:]/},t.languages.javascript=t.languages.extend("clike",{"class-name":[t.languages.clike["class-name"],{pattern:/(^|[^$\w\xA0-\uFFFF])(?!\s)[_$A-Z\xA0-\uFFFF](?:(?!\s)[$\w\xA0-\uFFFF])*(?=\.(?:constructor|prototype))/,lookbehind:!0}],keyword:[{pattern:/((?:^|\})\s*)catch\b/,lookbehind:!0},{pattern:/(^|[^.]|\.\.\.\s*)\b(?:as|assert(?=\s*\{)|async(?=\s*(?:function\b|\(|[$\w\xA0-\uFFFF]|$))|await|break|case|class|const|continue|debugger|default|delete|do|else|enum|export|extends|finally(?=\s*(?:\{|$))|for|from(?=\s*(?:['"]|$))|function|(?:get|set)(?=\s*(?:[#\[$\w\xA0-\uFFFF]|$))|if|implements|import|in|instanceof|interface|let|new|null|of|package|private|protected|public|return|static|super|switch|this|throw|try|typeof|undefined|var|void|while|with|yield)\b/,lookbehind:!0}],function:/#?(?!\s)[_$a-zA-Z\xA0-\uFFFF](?:(?!\s)[$\w\xA0-\uFFFF])*(?=\s*(?:\.\s*(?:apply|bind|call)\s*)?\()/,number:{pattern:RegExp(/(^|[^\w$])/.source+"(?:"+(/NaN|Infinity/.source+"|"+/0[bB][01]+(?:_[01]+)*n?/.source+"|"+/0[oO][0-7]+(?:_[0-7]+)*n?/.source+"|"+/0[xX][\dA-Fa-f]+(?:_[\dA-Fa-f]+)*n?/.source+"|"+/\d+(?:_\d+)*n/.source+"|"+/(?:\d+(?:_\d+)*(?:\.(?:\d+(?:_\d+)*)?)?|\.\d+(?:_\d+)*)(?:[Ee][+-]?\d+(?:_\d+)*)?/.source)+")"+/(?![\w$])/.source),lookbehind:!0},operator:/--|\+\+|\*\*=?|=>|&&=?|\|\|=?|[!=]==|<<=?|>>>?=?|[-+*/%&|^!=<>]=?|\.{3}|\?\?=?|\?\.?|[~:]/}),t.languages.javascript["class-name"][0].pattern=/(\b(?:class|extends|implements|instanceof|interface|new)\s+)[\w.\\]+/,t.languages.insertBefore("javascript","keyword",{regex:{pattern:RegExp(/((?:^|[^$\w\xA0-\uFFFF."'\])\s]|\b(?:return|yield))\s*)/.source+/\//.source+"(?:"+/(?:\[(?:[^\]\\\r\n]|\\.)*\]|\\.|[^/\\\[\r\n])+\/[dgimyus]{0,7}/.source+"|"+/(?:\[(?:[^[\]\\\r\n]|\\.|\[(?:[^[\]\\\r\n]|\\.|\[(?:[^[\]\\\r\n]|\\.)*\])*\])*\]|\\.|[^/\\\[\r\n])+\/[dgimyus]{0,7}v[dgimyus]{0,7}/.source+")"+/(?=(?:\s|\/\*(?:[^*]|\*(?!\/))*\*\/)*(?:$|[\r\n,.;:})\]]|\/\/))/.source),lookbehind:!0,greedy:!0,inside:{"regex-source":{pattern:/^(\/)[\s\S]+(?=\/[a-z]*$)/,lookbehind:!0,alias:"language-regex",inside:t.languages.regex},"regex-delimiter":/^\/|\/$/,"regex-flags":/^[a-z]+$/}},"function-variable":{pattern:/#?(?!\s)[_$a-zA-Z\xA0-\uFFFF](?:(?!\s)[$\w\xA0-\uFFFF])*(?=\s*[=:]\s*(?:async\s*)?(?:\bfunction\b|(?:\((?:[^()]|\([^()]*\))*\)|(?!\s)[_$a-zA-Z\xA0-\uFFFF](?:(?!\s)[$\w\xA0-\uFFFF])*)\s*=>))/,alias:"function"},parameter:[{pattern:/(function(?:\s+(?!\s)[_$a-zA-Z\xA0-\uFFFF](?:(?!\s)[$\w\xA0-\uFFFF])*)?\s*\(\s*)(?!\s)(?:[^()\s]|\s+(?![\s)])|\([^()]*\))+(?=\s*\))/,lookbehind:!0,inside:t.languages.javascript},{pattern:/(^|[^$\w\xA0-\uFFFF])(?!\s)[_$a-z\xA0-\uFFFF](?:(?!\s)[$\w\xA0-\uFFFF])*(?=\s*=>)/i,lookbehind:!0,inside:t.languages.javascript},{pattern:/(\(\s*)(?!\s)(?:[^()\s]|\s+(?![\s)])|\([^()]*\))+(?=\s*\)\s*=>)/,lookbehind:!0,inside:t.languages.javascript},{pattern:/((?:\b|\s|^)(?!(?:as|async|await|break|case|catch|class|const|continue|debugger|default|delete|do|else|enum|export|extends|finally|for|from|function|get|if|implements|import|in|instanceof|interface|let|new|null|of|package|private|protected|public|return|set|static|super|switch|this|throw|try|typeof|undefined|var|void|while|with|yield)(?![$\w\xA0-\uFFFF]))(?:(?!\s)[_$a-zA-Z\xA0-\uFFFF](?:(?!\s)[$\w\xA0-\uFFFF])*\s*)\(\s*|\]\s*\(\s*)(?!\s)(?:[^()\s]|\s+(?![\s)])|\([^()]*\))+(?=\s*\)\s*\{)/,lookbehind:!0,inside:t.languages.javascript}],constant:/\b[A-Z](?:[A-Z_]|\dx?)*\b/}),t.languages.insertBefore("javascript","string",{hashbang:{pattern:/^#!.*/,greedy:!0,alias:"comment"},"template-string":{pattern:/`(?:\\[\s\S]|\$\{(?:[^{}]|\{(?:[^{}]|\{[^}]*\})*\})+\}|(?!\$\{)[^\\`])*`/,greedy:!0,inside:{"template-punctuation":{pattern:/^`|`$/,alias:"string"},interpolation:{pattern:/((?:^|[^\\])(?:\\{2})*)\$\{(?:[^{}]|\{(?:[^{}]|\{[^}]*\})*\})+\}/,lookbehind:!0,inside:{"interpolation-punctuation":{pattern:/^\$\{|\}$/,alias:"punctuation"},rest:t.languages.javascript}},string:/[\s\S]+/}},"string-property":{pattern:/((?:^|[,{])[ \t]*)(["'])(?:\\(?:\r\n|[\s\S])|(?!\2)[^\\\r\n])*\2(?=\s*:)/m,lookbehind:!0,greedy:!0,alias:"property"}}),t.languages.insertBefore("javascript","operator",{"literal-property":{pattern:/((?:^|[,{])[ \t]*)(?!\s)[_$a-zA-Z\xA0-\uFFFF](?:(?!\s)[$\w\xA0-\uFFFF])*(?=\s*:)/m,lookbehind:!0,alias:"property"}}),t.languages.markup&&(t.languages.markup.tag.addInlined("script","javascript"),t.languages.markup.tag.addAttribute(/on(?:abort|blur|change|click|composition(?:end|start|update)|dblclick|error|focus(?:in|out)?|key(?:down|up)|load|mouse(?:down|enter|leave|move|out|over|up)|reset|resize|scroll|select|slotchange|submit|unload|wheel)/.source,"javascript")),t.languages.js=t.languages.javascript,function(){if(typeof t=="undefined"||typeof document=="undefined")return;Element.prototype.matches||(Element.prototype.matches=Element.prototype.msMatchesSelector||Element.prototype.webkitMatchesSelector);var i="Loading\u2026",s=function(m,w){return"\u2716 Error "+m+" while fetching file: "+w},r="\u2716 Error: File does not exist or is empty",o={js:"javascript",py:"python",rb:"ruby",ps1:"powershell",psm1:"powershell",sh:"bash",bat:"batch",h:"c",tex:"latex"},a="data-src-status",l="loading",c="loaded",h="failed",u="pre[data-src]:not(["+a+'="'+c+'"]):not(['+a+'="'+l+'"])';function d(m,w,E){var p=new XMLHttpRequest;p.open("GET",m,!0),p.onreadystatechange=function(){p.readyState==4&&(p.status<400&&p.responseText?w(p.responseText):p.status>=400?E(s(p.status,p.statusText)):E(r))},p.send(null)}function g(m){var w=/^\s*(\d+)\s*(?:(,)\s*(?:(\d+)\s*)?)?$/.exec(m||"");if(w){var E=Number(w[1]),p=w[2],f=w[3];return p?f?[E,Number(f)]:[E,void 0]:[E,E]}}t.hooks.add("before-highlightall",function(m){m.selector+=", "+u}),t.hooks.add("before-sanity-check",function(m){var w=m.element;if(w.matches(u)){m.code="",w.setAttribute(a,l);var E=w.appendChild(document.createElement("CODE"));E.textContent=i;var p=w.getAttribute("data-src"),f=m.language;if(f==="none"){var y=(/\.(\w+)$/.exec(p)||[,"none"])[1];f=o[y]||y}t.util.setLanguage(E,f),t.util.setLanguage(w,f);var _=t.plugins.autoloader;_&&_.loadLanguages(f),d(p,function(b){w.setAttribute(a,c);var C=g(w.getAttribute("data-range"));if(C){var k=b.split(/\r\n?|\n/g),T=C[0],L=C[1]==null?k.length:C[1];T<0&&(T+=k.length),T=Math.max(0,Math.min(T-1,k.length)),L<0&&(L+=k.length),L=Math.max(0,Math.min(L,k.length)),b=k.slice(T,L).join(`
`),w.hasAttribute("data-start")||w.setAttribute("data-start",String(T+1))}E.textContent=b,t.highlightElement(E)},function(b){w.setAttribute(a,h),E.textContent=b})}}),t.plugins.fileHighlight={highlight:function(w){for(var E=(w||document).querySelectorAll(u),p=0,f;f=E[p++];)t.highlightElement(f)}};var v=!1;t.fileHighlight=function(){v||(console.warn("Prism.fileHighlight is deprecated. Use `Prism.plugins.fileHighlight.highlight` instead."),v=!0),t.plugins.fileHighlight.highlight.apply(this,arguments)}}()})(ou);var Fe=ou.exports;function Ov(n){var jn,Vt;let e,t,i,s,r,o,a,l,c,h,u,d,g,v,m=Fe.highlight(((jn=n[0])==null?void 0:jn.html)||"(No data received)",Fe.languages.html)+"",w,E,p,f,y=Fe.highlight(((Vt=n[0])==null?void 0:Vt.css)||"",Fe.languages.css)+"",_,b,C,k,T,L,V,he,le,vt,Hn;return L=new wa({props:{html:n[4].html,css:n[4].css}}),{c(){e=P("div"),t=P("div"),i=P("h1"),s=Ze("Spectating "),r=P("button"),o=P("strong"),a=Ze(n[3]),l=X(),c=P("button"),c.innerHTML=`<div class="bg-white h-[2px] absolute inset-x-0 top-1/2 rotate-45"></div> 
      <div class="bg-white h-[2px] absolute inset-x-0 top-1/2 -rotate-45"></div>`,h=X(),u=P("div"),d=P("div"),g=P("div"),v=P("pre"),w=X(),E=P("div"),p=X(),f=P("pre"),_=X(),b=P("div"),k=X(),T=P("div"),Ft(L.$$.fragment),he=X(),S(i,"class","text-5xl text-center"),S(c,"class","absolute top-8 right-8 w-8 h-8"),S(v,"wrap","wrap"),S(v,"class","break-words"),S(E,"class","h-px bg-gray-700 my-12"),S(f,"wrap","wrap"),S(f,"class","break-words"),S(g,"class","absolute inset-0 overflow-auto p-8"),S(d,"class","bg-black flex-auto relative"),S(b,"class",C="flex-none w-4 cursor-ew-resize "+(n[1]?"bg-sky-400":"")),S(T,"class",V="flex-none h-[720px] "+(n[1]?"pointer-events-none select-none":"")+" relative"),Mr(T,"width",n[2]+"px"),S(u,"class","flex justify-center mt-4 p-8"),S(t,"class","p-8"),S(e,"class","absolute z-10 inset-0 overflow-y-auto bg-gradient-to-b from-slate-800 to-slate-700 flex flex-col justify-center"),S(e,"aria-labelledby","modal-title"),S(e,"role","dialog"),S(e,"aria-modal","true")},m(M,j){ne(M,e,j),A(e,t),A(t,i),A(i,s),A(i,r),A(r,o),A(o,a),A(t,l),A(t,c),A(t,h),A(t,u),A(u,d),A(d,g),A(g,v),v.innerHTML=m,A(g,w),A(g,E),A(g,p),A(g,f),f.innerHTML=y,A(u,_),A(u,b),A(u,k),A(u,T),dt(L,T,null),ne(M,he,j),le=!0,vt||(Hn=[Ie(r,"click",n[8]),Ie(c,"click",n[13]),Ie(b,"mousedown",n[14]),Ie(document.body,"mousemove",n[15]),Ie(document.body,"mouseup",n[16])],vt=!0)},p(M,[j]){var ze,se;(!le||j&8)&&Ms(a,M[3]),(!le||j&1)&&m!==(m=Fe.highlight(((ze=M[0])==null?void 0:ze.html)||"(No data received)",Fe.languages.html)+"")&&(v.innerHTML=m),(!le||j&1)&&y!==(y=Fe.highlight(((se=M[0])==null?void 0:se.css)||"",Fe.languages.css)+"")&&(f.innerHTML=y),(!le||j&2&&C!==(C="flex-none w-4 cursor-ew-resize "+(M[1]?"bg-sky-400":"")))&&S(b,"class",C);const be={};j&16&&(be.html=M[4].html),j&16&&(be.css=M[4].css),L.$set(be),(!le||j&2&&V!==(V="flex-none h-[720px] "+(M[1]?"pointer-events-none select-none":"")+" relative"))&&S(T,"class",V),(!le||j&4)&&Mr(T,"width",M[2]+"px")},i(M){le||(q(L.$$.fragment,M),le=!0)},o(M){te(L.$$.fragment,M),le=!1},d(M){M&&J(e),ft(L),M&&J(he),vt=!1,ht(Hn)}}}function xv(n,e,t){let i,s,r,o,a,l=z,c=()=>(l(),l=Tt(s,k=>t(12,a=k)),s),h,u=z,d=()=>(u(),u=Tt(i,k=>t(0,h=k)),i);n.$$.on_destroy.push(()=>l()),n.$$.on_destroy.push(()=>u());let{uid:g}=e,{index:v=void 0}=e,m=!1,w;const E=Eu();let p=540;const f=()=>{t(11,m=!m)},y=()=>E("close"),_=k=>t(1,w={lastX:k.clientX}),b=k=>{w&&(t(2,p+=w.lastX-k.clientX),t(1,w.lastX=k.clientX,w))},C=()=>t(1,w=void 0);return n.$$set=k=>{"uid"in k&&t(9,g=k.uid),"index"in k&&t(10,v=k.index)},n.$$.update=()=>{n.$$.dirty&512&&d(t(6,i=iu(g))),n.$$.dirty&512&&c(t(5,s=su(g))),n.$$.dirty&1&&t(4,r=va(h)),n.$$.dirty&7168&&t(3,o=m&&a.name||(v!=null?`Contestant ${v+1}`:"User"))},[h,w,p,o,r,s,i,E,f,g,v,m,a,y,_,b,C]}class Dv extends kn{constructor(e){super(),Sn(this,e,xv,Ov,Lt,{uid:9,index:10})}}function na(n,e,t){const i=n.slice();return i[17]=e[t],i[16]=t,i}function ia(n,e,t){const i=n.slice();return i[14]=e[t],i[16]=t,i}function sa(n,e,t){const i=n.slice();return i[17]=e[t],i[16]=t,i}function Mv(n){let e,t,i,s,r,o,a,l,c,h,u,d=n[3],g=[];for(let m=0;m<d.length;m+=1)g[m]=ra(na(n,d,m));const v=m=>te(g[m],1,1,()=>{g[m]=null});return{c(){e=P("div"),t=P("div"),i=P("img"),r=X(),o=P("div"),a=P("div"),l=P("div");for(let m=0;m<g.length;m+=1)g[m].c();S(i,"class","shadow-lg rounded"),tn(i.src,s=n[4])||S(i,"src",s),S(i,"alt","Template"),S(i,"width","540"),S(t,"class","flex-none flex flex-col justify-center p-4 bg-slate-900/50"),S(l,"class","m-auto flex-auto flex flex-wrap gap-4 justify-center px-4 py-8"),S(a,"class","absolute inset-0 flex overflow-x-hidden overflow-y-[overlay]"),S(o,"class","flex-auto relative"),S(e,"class","flex inset-0 absolute")},m(m,w){ne(m,e,w),A(e,t),A(t,i),A(e,r),A(e,o),A(o,a),A(a,l);for(let E=0;E<g.length;E+=1)g[E].m(l,null);c=!0,h||(u=Ie(i,"dblclick",n[12]),h=!0)},p(m,w){if((!c||w&16&&!tn(i.src,s=m[4]))&&S(i,"src",s),w&72){d=m[3];let E;for(E=0;E<d.length;E+=1){const p=na(m,d,E);g[E]?(g[E].p(p,w),q(g[E],1)):(g[E]=ra(p),g[E].c(),q(g[E],1),g[E].m(l,null))}for(dn(),E=d.length;E<g.length;E+=1)v(E);fn()}},i(m){if(!c){for(let w=0;w<d.length;w+=1)q(g[w]);c=!0}},o(m){g=g.filter(Boolean);for(let w=0;w<g.length;w+=1)te(g[w]);c=!1},d(m){m&&J(e),us(g,m),h=!1,u()}}}function Lv(n){let e,t,i,s,r,o,a,l,c,h,u,d,g,v=n[0],m=[];for(let f=0;f<v.length;f+=1)m[f]=oa(sa(n,v,f));const w=f=>te(m[f],1,1,()=>{m[f]=null});let E=ca(n[0]),p=[];for(let f=0;f<E.length;f+=1)p[f]=aa(ia(n,E,f));return{c(){e=P("div"),t=P("div"),i=P("div"),s=P("img"),o=X();for(let f=0;f<m.length;f+=1)m[f].c();a=X();for(let f=0;f<p.length;f+=1)p[f].c();l=X(),c=P("img"),S(s,"class","shadow-lg rounded"),tn(s.src,r=n[4])||S(s,"src",r),S(s,"alt","Template"),S(i,"class","template-image svelte-1qggf9"),S(t,"class","grid-view svelte-1qggf9"),S(e,"class","flex items-center justify-center inset-0 absolute"),tn(c.src,h=xu)||S(c,"src",h),S(c,"alt",""),S(c,"class","absolute top-8 left-8 w-[21.823vw]")},m(f,y){ne(f,e,y),A(e,t),A(t,i),A(i,s),A(t,o);for(let _=0;_<m.length;_+=1)m[_].m(t,null);A(t,a);for(let _=0;_<p.length;_+=1)p[_].m(t,null);ne(f,l,y),ne(f,c,y),u=!0,d||(g=Ie(s,"dblclick",n[10]),d=!0)},p(f,y){if((!u||y&16&&!tn(s.src,r=f[4]))&&S(s,"src",r),y&97){v=f[0];let _;for(_=0;_<v.length;_+=1){const b=sa(f,v,_);m[_]?(m[_].p(b,y),q(m[_],1)):(m[_]=oa(b),m[_].c(),q(m[_],1),m[_].m(t,a))}for(dn(),_=v.length;_<m.length;_+=1)w(_);fn()}if(y&1){E=ca(f[0]);let _;for(_=0;_<E.length;_+=1){const b=ia(f,E,_);p[_]?p[_].p(b,y):(p[_]=aa(),p[_].c(),p[_].m(t,null))}for(;_<p.length;_+=1)p[_].d(1);p.length=E.length}},i(f){if(!u){for(let y=0;y<v.length;y+=1)q(m[y]);u=!0}},o(f){m=m.filter(Boolean);for(let y=0;y<m.length;y+=1)te(m[y]);u=!1},d(f){f&&J(e),us(m,f),us(p,f),f&&J(l),f&&J(c),d=!1,g()}}}function ra(n){let e,t,i,s;function r(){return n[13](n[17])}return t=new ru({props:{uid:n[17],index:n[16],namePrefix:"User"}}),t.$on("click",r),{c(){e=P("div"),Ft(t.$$.fragment),i=X(),S(e,"class","flex-none")},m(o,a){ne(o,e,a),dt(t,e,null),A(e,i),s=!0},p(o,a){n=o;const l={};a&8&&(l.uid=n[17]),t.$set(l)},i(o){s||(q(t.$$.fragment,o),s=!0)},o(o){te(t.$$.fragment,o),s=!1},d(o){o&&J(e),ft(t)}}}function oa(n){let e,t,i;function s(){return n[11](n[17],n[16])}return t=new ru({props:{uid:n[17],index:n[16],namesRevealed:n[5]}}),t.$on("click",s),{c(){e=P("div"),Ft(t.$$.fragment)},m(r,o){ne(r,e,o),dt(t,e,null),i=!0},p(r,o){n=r;const a={};o&1&&(a.uid=n[17]),o&32&&(a.namesRevealed=n[5]),t.$set(a)},i(r){i||(q(t.$$.fragment,r),i=!0)},o(r){te(t.$$.fragment,r),i=!1},d(r){r&&J(e),ft(t)}}}function aa(n){let e;return{c(){e=P("div"),e.textContent=`(No Player)
        `,S(e,"class","flex items-center justify-center rounded text-2xl bg-slate-500 shadow-lg")},m(t,i){ne(t,e,i)},p:z,d(t){t&&J(e)}}}function la(n){let e,t,i,s;const r=[n[1]];let o={};for(let a=0;a<r.length;a+=1)o=hu(o,r[a]);return t=new Dv({props:o}),t.$on("close",n[7]),{c(){e=P("div"),Ft(t.$$.fragment),S(e,"class","absolute inset-0")},m(a,l){ne(a,e,l),dt(t,e,null),s=!0},p(a,l){const c=l&2?Nu(r,[Pu(a[1])]):{};t.$set(c)},i(a){s||(q(t.$$.fragment,a),hn(()=>{i||(i=Ur(e,$r,{duration:100},!0)),i.run(1)}),s=!0)},o(a){te(t.$$.fragment,a),i||(i=Ur(e,$r,{duration:100},!1)),i.run(0),s=!1},d(a){a&&J(e),ft(t),a&&i&&i.end()}}}function Fv(n){let e,t,i,s,r;const o=[Lv,Mv],a=[];function l(h,u){return h[2]==="stage"?0:1}e=l(n),t=a[e]=o[e](n);let c=n[1]&&la(n);return{c(){t.c(),i=X(),c&&c.c(),s=_a()},m(h,u){a[e].m(h,u),ne(h,i,u),c&&c.m(h,u),ne(h,s,u),r=!0},p(h,[u]){let d=e;e=l(h),e===d?a[e].p(h,u):(dn(),te(a[d],1,1,()=>{a[d]=null}),fn(),t=a[e],t?t.p(h,u):(t=a[e]=o[e](h),t.c()),q(t,1),t.m(i.parentNode,i)),h[1]?c?(c.p(h,u),u&2&&q(c,1)):(c=la(h),c.c(),q(c,1),c.m(s.parentNode,s)):c&&(dn(),te(c,1,1,()=>{c=null}),fn())},i(h){r||(q(t),q(c),r=!0)},o(h){te(t),te(c),r=!1},d(h){a[e].d(h),h&&J(i),c&&c.d(h),h&&J(s)}}}function Uv(n,e){const t=new Set(e);return n.filter(i=>!t.has(i))}function ca(n){return new Array(Math.max(0,8-n.length)).fill("")}function $v(n,e,t){let i,s,r,o,a,l;Xt(n,Sv,E=>t(8,r=E)),Xt(n,Tv,E=>t(9,o=E)),Xt(n,Rv,E=>t(4,a=E)),Xt(n,Av,E=>t(5,l=E));let c=null,h="stage";function u(E,p){t(1,c={uid:E,index:p})}function d(){t(1,c=null)}const g=()=>t(2,h="all"),v=(E,p)=>u(E,p),m=()=>t(2,h="stage"),w=E=>u(E);return n.$$.update=()=>{n.$$.dirty&512&&t(0,i=o||[]),n.$$.dirty&257&&t(3,s=Uv(r,i))},[i,c,h,s,a,l,u,d,r,o,g,v,m,w]}class Wv extends kn{constructor(e){super(),Sn(this,e,$v,Fv,Lt,{})}}const bt=[];function Hv(n,e=z){let t;const i=new Set;function s(a){if(Lt(n,a)&&(n=a,t)){const l=!bt.length;for(const c of i)c[1](),bt.push(c,n);if(l){for(let c=0;c<bt.length;c+=2)bt[c][0](bt[c+1]);bt.length=0}}}function r(a){s(a(n))}function o(a,l=z){const c=[a,l];return i.add(c),i.size===1&&(t=e(s)||z),a(n),()=>{i.delete(c),i.size===0&&(t(),t=null)}}return{set:s,update:r,subscribe:o}}const ti=Hv("checking");zc($n,n=>{au(n)});Iv.then(()=>{au($n.currentUser)});function au(n){n?n.getIdTokenResult().then(e=>{ti.set(e.claims.management?"authorized":"unauthorized")}).catch(e=>{console.error(e),ti.set("error")}):ti.set("unauthenticated")}function jv(n){return ly($n,n)}Object.assign(window,{signOut:()=>cy($n)});function Bv(n){let e,t,i,s,r,o,a,l;return{c(){e=P("div"),t=Ze("Access state: "),i=Ze(n[0]),s=X(),r=P("div"),o=P("button"),o.textContent="Authenticate",S(o,"class","bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded"),S(r,"class","mt-4"),S(e,"class","p-6")},m(c,h){ne(c,e,h),A(e,t),A(e,i),A(e,s),A(e,r),A(r,o),a||(l=Ie(o,"click",n[2]),a=!0)},p(c,h){h&1&&Ms(i,c[0])},i:z,o:z,d(c){c&&J(e),a=!1,l()}}}function Vv(n){let e,t;return e=new Wv({}),{c(){Ft(e.$$.fragment)},m(i,s){dt(e,i,s),t=!0},p:z,i(i){t||(q(e.$$.fragment,i),t=!0)},o(i){te(e.$$.fragment,i),t=!1},d(i){ft(e,i)}}}function qv(n){let e,t,i,s;const r=[Vv,Bv],o=[];function a(l,c){return l[0]==="authorized"?0:1}return e=a(n),t=o[e]=r[e](n),{c(){t.c(),i=_a()},m(l,c){o[e].m(l,c),ne(l,i,c),s=!0},p(l,[c]){let h=e;e=a(l),e===h?o[e].p(l,c):(dn(),te(o[h],1,1,()=>{o[h]=null}),fn(),t=o[e],t?t.p(l,c):(t=o[e]=r[e](l),t.c()),q(t,1),t.m(i.parentNode,i))},i(l){s||(q(t),s=!0)},o(l){te(t),s=!1},d(l){o[e].d(l),l&&J(i)}}}function zv(n,e,t){let i;Xt(n,ti,o=>t(0,i=o));function s(){const o=prompt("token");o&&jv(o).catch(a=>{console.error(a),alert(String(a))})}return[i,s,()=>s()]}class Gv extends kn{constructor(e){super(),Sn(this,e,zv,qv,Lt,{})}}new Gv({target:document.getElementById("app")});
